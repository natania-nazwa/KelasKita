    ...
    <div class="lg:flex min-h-screen">
        ...
        <aside class="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 bg-dark text-white">
            <div class="flex items-center gap-3 px-6 h-16 border-b border-white/10">
                ...
                <a href="{{ url('/admin/dashboard') }}" class="text-lg font-semibold">KelasKita</a>
            </div>
        ...
        <div class="flex-1 lg:ml-64">
            ...
            <header class="lg:hidden sticky top-0 z-20 bg-dark text-white">
                ...
                <nav class="flex gap-1 px-3 pb-3 overflow-x-auto">
                    ...
                    <a href="#" class="shrink-0 px-3 py-1.5 rounded-lg text-xs font-medium text-white/70">Pengguna</a>
                    <a href="#" class="shrink-0 px-3 py-1.5 rounded-lg text-xs font-medium text-white/70">Pelajaran</a>
                    ...
                    <a href="#" class="shrink-0 px-3 py-1.5 rounded-lg text-xs font-medium text-white/70">Pengaturan</a>
                </nav>
            </header>
