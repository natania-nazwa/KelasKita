...
<div class="min-h-screen flex flex-col items-center justify-center px-4 py-12">
    ...
    <div class="w-full max-w-md rounded-3xl bg-white border border-lavender shadow-xl shadow-dark/5 p-8 sm:p-10">
        <h1 class="text-2xl font-extrabold text-dark">Selamat Datang di KelasKita</h1>
        <p class="mt-2 text-sm text-dark/60">Masuk untuk melanjutkan belajarmu.</p>
        ...
        <form action="#" method="POST" class="mt-8 space-y-5">
            ...
            <div>
                <div class="flex items-center justify-between">
                    ...
                    <a href="#" class="text-xs font-medium text-primary hover:text-primary-dark">Lupa kata sandi?</a>
                </div>
        ...
        <p class="mt-6 text-center text-sm text-dark/60">
            Belum punya akun?
            <a href="{{ url('/register') }}" class="font-semibold text-primary hover:text-primary-dark">Daftar</a>
        </p>
    </div>
